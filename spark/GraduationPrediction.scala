...
object GraduationPrediction {
  def main(args: Array[String]): Unit = {
    ...
    val lrModel = lr.fit(trainingData)
        // 保存模型到本地
    val modelPath = "C:/Users/73269/Desktop/ab/2024/大三下/Web系统设计/大作业/code/GraduationManagementSystem/web/mode/model1" // 替换为你想要保存模型的实际路径
